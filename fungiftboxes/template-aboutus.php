...
<?php get_header(); ?>
	...
	<main role="main">
 		...
 		<!-- INTRO PARAGRAPH -->
 		<section id="headerimg-about" class="full left" style="background: url(<?php the_post_thumbnail_url(); ?>) top center no-repeat; background-size: cover; height: 540px; ">
			...
			<div class="container">
				<div class="row" style="padding: 10px; margin: 0 !important;">
						...
						<div class="col-lg-8 col-md-8 col-md-offset-2 col-lg-offset-2 ">
							<div class="contentwrap" style="text-align: left;">
